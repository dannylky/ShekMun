...
$files = @(
    ...
    'avoip.html', 'dashboard_PTZ.html', 'ops-guide.html', 'case-followup.html', 'enhancement.html', 'spare-equipment.html', 'enhancements.txt', 'known-issues.txt', 'ops-guide-content.html', 'spare-equipment.json', 'user-admin.html', 'users.json', 'click-log.js', 'suspended.js',
